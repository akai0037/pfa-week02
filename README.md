...
The game also supports Ctrl+Z to return to the starting state of the game. The Delete function removes only the objects created by the tool without affecting other objects in the scene.
